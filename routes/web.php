...
//            Route::get('voided/ticket/{voided_id}/{group_id}', 'Tenant\VoidedController@ticket');
    ...
    Route::domain($app_url)->group(function() {
        // Route::get('/', 'System\LoginController@showLoginForm')->name('login');
...
Route::prefix('plans')->group(function () {
    ...
    Route::put('/{id}', 'PlanController@update')->name('plans.update');
    Route::delete('/{id}', 'PlanController@destroy')->name('plans.destroy');
});

// Rutas para documentos emitidos
