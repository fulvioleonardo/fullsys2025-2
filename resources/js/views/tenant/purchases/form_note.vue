<template>
    <div class="card mb-0 pt-2 pt-md-0">
            ...
            <form autocomplete="off" @submit.prevent="submit">
                <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group" :class="{ 'has-danger': errors.affected_document }">
                                <label class="control-label">Documento afectado <span
                                        class="text-danger">*</span></label>
                                <el-input v-model="form.affected_document" disabled></el-input>

                                <small class="form-control-feedback" v-if="errors.affected_document"
                                    v-text="errors.affected_document[0]"></small>
                            </div>
                        </div>
                        <div class="col-md-8 mt-4">
                            <div class="form-group">
                                <el-checkbox v-model="form.has_client" @change="changeHasClient">¿Desea agregar el
                                    cliente para esta compra?</el-checkbox>
                            </div>
                        </div>
                        <div class="col-md-8 mt-2 mb-2">
                            <div class="form-group">
                                <el-checkbox v-model="form.has_payment" @change="changeHasPayment">¿Desea agregar pagos
                                    a esta compra?</el-checkbox>
                            </div>
                        </div>
                    ...
                    <div class="row" v-if="form.items.length > 0">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr v-for="(row, index) in form.items" :key="index">
                                            ...
                                            <td class="text-left">{{ (row.warehouse_description) ?
                                                row.warehouse_description : row.warehouse.description }}</td>
                        ...
                        <div class="col-md-12">
                            ...
                            <template v-if="is_perception_agent">
                                ...
                                <h3 class="text-right" v-if="form.total > 0 && !hide_button"><b>MONTO TOTAL : </b>{{
                                    ratePrefix() }} {{ total_amount }}</h3>
        ...
        <purchase-form-item :showDialog.sync="showDialogAddItem" :currency-type-id-active="form.currency_type_id"
            :exchange-rate-sale="form.exchange_rate_sale" @add="addRow"></purchase-form-item>
    ...
    async created() {
        ...
        await this.$http.get(`/${this.resource}/tables`)
            .then(response => {
                ...
                this.document_types = response.data.document_types_notes
